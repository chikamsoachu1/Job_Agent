...
available_file_paths=[r"C:\Users\chika\Downloads\Chikamso-Anayor Achu-technical product manager (1).pdf"]
    ...
    try:
        ...
        if use_own_browser:
            ...
            if chrome_user_data:
                ...
                chrome_profile = os.getenv("CHROME_PROFILE", None)

                extra_chromium_args += [f"--profile-directory={chrome_profile}"]
    ...
    try:
        ...
        if use_own_browser:
            ...
            if chrome_user_data:
                ...
                #extra_chromium_args += [f"--profile-directory={user_data}"]
        ...
        headers = {
            ...
            "anchor-api-key": "sk-9bbd1fb0fb6aae2951b575be7e255e56",
        ...
        async def upload_file(index: int, path: str, browser: BrowserContext):
                ...
                if file_upload_dom_el is None:
                    ...
                    msg = f'No direct file upload element found at index {index}. Attempting alternative upload method.'

                    logger.info(msg)


                    # Try alternative method using page.expect_file_chooser()
                    ...
                    try:
                        ...
                        async with page.expect_file_chooser() as fc_info:
                            ...
                            await browser._click_element_node(dom_el)

                            #await dom_el.click()  # Click the button/element that triggers the file chooser

                        file_chooser = await fc_info.value

                        await file_chooser.set_files(path)

                        msg = f'Successfully uploaded file using alternative method to index {index}'
                        ...
                        msg = f'Alternative file upload method failed for index {index}: {str(e)}'

                        logger.error(msg, exc_info=True)  # Log the exception with traceback
