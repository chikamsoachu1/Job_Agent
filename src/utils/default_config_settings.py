...
def default_config():
    ...
    return {
        ...
        "task": """Go to https://www.linkedin.com/jobs/search/?&distance=25&f_AL=true&f_TPR=r86400&geoId=103644278&keywords=Product%20Manager&origin=JOB_SEARCH_PAGE_SEARCH_BUTTON&refresh=true&sortBy=DD&spellCorrectionEnabled=true
